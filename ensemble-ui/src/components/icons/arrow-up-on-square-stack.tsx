...
@Component({
  tag: 'eui-icon-arrow-up-on-square-stack',
  shadow: false,
})
export class EUIIconArrowUpOnSquareStack {
...
<path d="M5.26756 14C5.61337 14.5978 6.25972 15 7 15H11C12.1046 15 13 14.1046 13 13V10C13 9.25972 12.5978 8.61337 12 8.26756V11C12 12.6569 10.6569 14 9 14H5.26756Z" fill="#0F172A"/>
...
<path d="M6.25 8.75C6.25 9.16421 6.58579 9.5 7 9.5C7.41421 9.5 7.75 9.16421 7.75 8.75L7.75 6H9C10.1046 6 11 6.89543 11 8V11C11 12.1046 10.1046 13 9 13H5C3.89543 13 3 12.1046 3 11V8C3 6.89543 3.89543 6 5 6H6.25L6.25 8.75Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
