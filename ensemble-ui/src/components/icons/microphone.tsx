...
@Component({
  tag: 'eui-icon-microphone',
  shadow: false,
})
export class EUIIconMicrophone {
...
<g clip-path="url(#clip0_158_2894)">
...
<path d="M8 1C6.89543 1 6 1.89543 6 3V7C6 8.10457 6.89543 9 8 9C9.10457 9 10 8.10457 10 7V3C10 1.89543 9.10457 1 8 1Z" fill="#0F172A"/>
