...
@Component({
  tag: 'eui-icon-clipboard',
  shadow: false,
})
export class EUIIconClipboard {
...
<path d="M15.6657 3.88789C15.3991 2.94272 14.5305 2.25 13.5 2.25H10.5C9.46954 2.25 8.60087 2.94272 8.33426 3.88789M15.6657 3.88789C15.7206 4.0825 15.75 4.28782 15.75 4.5C15.75 4.91421 15.4142 5.25 15 5.25H9C8.58579 5.25 8.25 4.91421 8.25 4.5C8.25 4.28782 8.27937 4.0825 8.33426 3.88789M15.6657 3.88789C16.3119 3.93668 16.9545 3.99828 17.5933 4.07241C18.6939 4.20014 19.5 5.149 19.5 6.25699V19.5C19.5 20.7426 18.4926 21.75 17.25 21.75H6.75C5.50736 21.75 4.5 20.7426 4.5 19.5V6.25699C4.5 5.149 5.30608 4.20014 6.40668 4.07241C7.04547 3.99828 7.68808 3.93668 8.33426 3.88789" stroke="#0F172A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.9863 3H12C13.1046 3 14 3.89543 14 5V13C14 14.1046 13.1046 15 12 15H4C2.89543 15 2 14.1046 2 13V5C2 3.89543 2.89543 3 4 3H5.01373C5.13809 1.87501 6.09186 1 7.25 1H8.75C9.90814 1 10.8619 1.87501 10.9863 3ZM9.5 4V3.25C9.5 2.83579 9.16421 2.5 8.75 2.5H7.25C6.83579 2.5 6.5 2.83579 6.5 3.25V4H9.5Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
