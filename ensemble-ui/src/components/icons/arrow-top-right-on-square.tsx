...
@Component({
  tag: 'eui-icon-arrow-top-right-on-square',
  shadow: false,
})
export class EUIIconArrowTopRightOnSquare {
...
<path d="M3.5 6.75C3.5 6.05964 4.05964 5.5 4.75 5.5H7C7.41421 5.5 7.75 5.16421 7.75 4.75C7.75 4.33579 7.41421 4 7 4H4.75C3.23122 4 2 5.23122 2 6.75V11.25C2 12.7688 3.23122 14 4.75 14H9.25C10.7688 14 12 12.7688 12 11.25V9C12 8.58579 11.6642 8.25 11.25 8.25C10.8358 8.25 10.5 8.58579 10.5 9V11.25C10.5 11.9404 9.94036 12.5 9.25 12.5H4.75C4.05964 12.5 3.5 11.9404 3.5 11.25V6.75Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
