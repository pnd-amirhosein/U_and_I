...
@Component({
  tag: 'eui-icon-video-camera-slash',
  shadow: false,
})
export class EUIIconVideoCameraSlash {
...
<path d="M0.96967 3.96967C1.26256 3.67678 1.73744 3.67678 2.03033 3.96967L17.0303 18.9697C17.3232 19.2626 17.3232 19.7374 17.0303 20.0303C16.7374 20.3232 16.2626 20.3232 15.9697 20.0303L0.96967 5.03033C0.676777 4.73744 0.676777 4.26256 0.96967 3.96967Z" fill="#0F172A"/>
<path d="M17.25 16.0606L19.9393 18.75C20.8843 19.6949 22.5 19.0257 22.5 17.6893V6.31063C22.5 4.97427 20.8843 4.30501 19.9393 5.24996L17.25 7.93931V16.0606Z" fill="#0F172A"/>
<path d="M15.75 7.5V15.568L4.68198 4.5H12.75C14.4069 4.5 15.75 5.84315 15.75 7.5Z" fill="#0F172A"/>
<path d="M1.5 16.5V7.68198L13.2727 19.4546C13.1029 19.4845 12.9283 19.5 12.75 19.5H4.5C2.84315 19.5 1.5 18.1569 1.5 16.5Z" fill="#0F172A"/>
</svg>
`;
...
<path d="M1 10V6.68198L6.31802 12H3C1.89543 12 1 11.1046 1 10Z" fill="#0F172A"/>
<path d="M10 6V9.31802L4.68198 4H8C9.10457 4 10 4.89543 10 6Z" fill="#0F172A"/>
<path d="M14.537 4.05711C14.8173 4.1732 15 4.44668 15 4.75002V11.25C15 11.5534 14.8173 11.8268 14.537 11.9429C14.2568 12.059 13.9342 11.9949 13.7197 11.7804L11.7197 9.78035C11.579 9.6397 11.5 9.44893 11.5 9.25002V6.75002C11.5 6.55111 11.579 6.36034 11.7197 6.21969L13.7197 4.21969C13.9342 4.00519 14.2568 3.94103 14.537 4.05711Z" fill="#0F172A"/>
<path d="M2.78033 4.21967C2.48744 3.92678 2.01256 3.92678 1.71967 4.21967C1.42678 4.51256 1.42678 4.98744 1.71967 5.28033L8.21967 11.7803C8.51256 12.0732 8.98744 12.0732 9.28033 11.7803C9.57322 11.4874 9.57322 11.0126 9.28033 10.7197L2.78033 4.21967Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
