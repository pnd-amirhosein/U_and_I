...
@Component({
  tag: 'eui-icon-device-tablet',
  shadow: false,
})
export class EUIIconDeviceTablet {
...
<path d="M7.25 11.5C6.83579 11.5 6.5 11.8358 6.5 12.25C6.5 12.6642 6.83579 13 7.25 13H8.75C9.16421 13 9.5 12.6642 9.5 12.25C9.5 11.8358 9.16421 11.5 8.75 11.5H7.25Z" fill="#0F172A"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.5C2 2.11929 3.11929 1 4.5 1H11.5C12.8807 1 14 2.11929 14 3.5V12.5C14 13.8807 12.8807 15 11.5 15H4.5C3.11929 15 2 13.8807 2 12.5V3.5ZM4.5 2.5H11.5C12.0523 2.5 12.5 2.94772 12.5 3.5V12.5C12.5 13.0523 12.0523 13.5 11.5 13.5H4.5C3.94772 13.5 3.5 13.0523 3.5 12.5V3.5C3.5 2.94772 3.94772 2.5 4.5 2.5Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
