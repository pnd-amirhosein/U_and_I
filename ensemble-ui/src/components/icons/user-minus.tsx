...
@Component({
  tag: 'eui-icon-user-minus',
  shadow: false,
})
export class EUIIconUserMinus {
...
<path d="M8.5 4.5C8.5 5.88071 7.38071 7 6 7C4.61929 7 3.5 5.88071 3.5 4.5C3.5 3.11929 4.61929 2 6 2C7.38071 2 8.5 3.11929 8.5 4.5Z" fill="#0F172A"/>
<path d="M9.99951 13C10.5518 13 11.0099 12.5478 10.9008 12.0064C10.44 9.72096 8.42072 8 5.99951 8C3.57829 8 1.55903 9.72096 1.09823 12.0064C0.989075 12.5478 1.44722 13 1.99951 13H9.99951Z" fill="#0F172A"/>
<path d="M10.75 5.25C10.3358 5.25 10 5.58579 10 6C10 6.41421 10.3358 6.75 10.75 6.75H14.25C14.6642 6.75 15 6.41421 15 6C15 5.58579 14.6642 5.25 14.25 5.25H10.75Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
