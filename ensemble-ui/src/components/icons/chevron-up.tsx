...
@Component({
  tag: 'eui-icon-chevron-up',
  shadow: false,
})
export class EUIIconChevronUp {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.46967 6.46967C9.76256 6.17678 10.2374 6.17678 10.5303 6.46967L14.7803 10.7197C15.0732 11.0126 15.0732 11.4874 14.7803 11.7803C14.4874 12.0732 14.0126 12.0732 13.7197 11.7803L10 8.06066L6.28033 11.7803C5.98744 12.0732 5.51256 12.0732 5.21967 11.7803C4.92678 11.4874 4.92678 11.0126 5.21967 10.7197L9.46967 6.46967Z" fill="#0F172A"/>
</svg>
`;
      case 'micro': return `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M11.7803 9.78033C11.4874 10.0732 11.0126 10.0732 10.7197 9.78033L8 7.06066L5.28033 9.78033C4.98744 10.0732 4.51256 10.0732 4.21967 9.78033C3.92678 9.48744 3.92678 9.01256 4.21967 8.71967L7.46967 5.46967C7.76256 5.17678 8.23744 5.17678 8.53033 5.46967L11.7803 8.71967C12.0732 9.01256 12.0732 9.48744 11.7803 9.78033Z" fill="#0F172A"/>
</svg>
`;
      default:
        return '';
