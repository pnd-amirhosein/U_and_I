...
import { formatHour12, getCalendarDays } from 'packages/core/utils/helpers/date/calendar.utils';
    ...
    render() {
        ...
        return (
            <div {...attrs} class="eui--mnv">
                ...
                <div class="weekdays">
                    {weekdays.map((day, i) => (
                        <div class={`weekday ${{ "weekend": ((i + 1) == 7) }}`}>{day}</div>
                    ))}
                </div>
                <div class="days-grid">
                    {days.map((date, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {events && (events.map(event => (<span class="event">
