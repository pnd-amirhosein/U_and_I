...
export class EUITextarea {
  ...
  @Prop() mode: 'normal' | 'outline' | 'text-textarea' = 'normal';
  @Prop() type: HTMLTextAreaElement['type'] = 'text';
  ...
  render() {
    ...
    return (
      <Host >
        <div class={`textarea-wrapper ${this.hostEl.getAttribute("class") ?? ""}`}
          style={this.styleValue ? parseStyleString(this.styleValue) : undefined}
        >
          <span class={`textarea ${!this.isValid && this.alert.type == 'danger' ? "danger" : ""} 
            ...
            <textarea
              ...
              class={{
                [`textarea--${this.mode}`]: this.mode !== 'normal',
              }}
