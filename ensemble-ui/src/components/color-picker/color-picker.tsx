...
export class EUIColorPicker {
    ...
    private async copyToClipboard() {
        ...
        try {
            await navigator.clipboard.writeText(this.previousHex);
        }
        catch (err) {
    ...
    private showPopup() {
        ...
        if (!this.popupEl) {
            ...
            this.colorAreaEl =
                this.popupEl.querySelector(".color-area") as HTMLElement;


            this.selectorEl =
                this.popupEl.querySelector(".color-selector") as HTMLElement;


            this.hueEl =
                this.popupEl.querySelector(".hue-slider") as HTMLElement;


            this.hueSelectorEl =
                this.popupEl.querySelector(".hue-selector") as HTMLElement;


            this.hexInputEl =
                this.popupEl.querySelector(".hex-input") as HTMLInputElement;

            this.confirmBtnEl =
                this.popupEl.querySelector(".confirm") as HTMLButtonElement;


            this.cancelBtnEl =
                this.popupEl.querySelector(".cancel") as HTMLButtonElement;



            this.confirmBtnEl.addEventListener(
                "click",
                this.confirmColor
            );
            ...
            this.colorAreaEl.addEventListener(
                "mousedown",
                this.handleColorPick
            );


            this.hueEl.addEventListener(
                "mousedown",
                this.handleHuePick
            );


            this.hexInputEl.addEventListener(
                "input",
                this.handleHexInput
            );
        ...
        this.triggerEl =
            this.hostEl.querySelector(".clp") as HTMLElement;
    ...
    private handleColorPick = (ev: MouseEvent) => {
        ...
        const rect =
            this.colorAreaEl.getBoundingClientRect();
    ...
    private handleHuePick = (ev: MouseEvent) => {
        ...
        const rect =
            this.hueEl.getBoundingClientRect();
    ...
    private updateHue() {
        ...
        if (this.colorAreaEl)
            ...
            this.colorAreaEl.style.background =
                `hsl(${this.hue},100%,50%)`;
    ...
    private moveSelector(x: number, y: number) {
        ...
        this.selectorEl.style.left =
            `${x}%`;


        this.selectorEl.style.top =
            `${y}%`;
