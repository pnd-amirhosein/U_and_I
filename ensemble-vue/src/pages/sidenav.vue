...
<template>
  <div class="doc">
    ...
    <span class="flex flex-col">
      <h4 class="title w-80 justify-start flex">
      ...
      <span class="side-nav-holder">
        ...
        <div class="simulator flex">
          ...
          <div class="body">
            ...
            <span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input type="number" :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input type="number" :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input type="password" :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
              <span><eui-input type="number" :nativeAttrs="{ placeHolder: 'simple input' }" /></span>
