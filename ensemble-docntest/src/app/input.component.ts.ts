  ...
  template: `
    <div class="doc">
      ...
      <span class="flex">
        ...
        <eui-input styleValue="width:25vw;" [validation]={maxLength:10} type="text"/>
      </span>
      <span class="flex">
        <h4 class="title">Success message</h4>
        <eui-input styleValue="width:25vw;" type="text" [validation]={custom:checkMate(sell)} [alert]="{ message: 'There is a success!', type: 'success' }"/>
      </span>
      <span class="flex">
        <h4 class="title">Password input</h4>
        <eui-input styleValue="width:25vw;" placeHolder="enter password" type="password"/>
      </span>
    </div>
    `
})
